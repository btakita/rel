...
(function() {
  ...
  Dot = (function(_super) {
    ...
    Dot.prototype.nary = function(o) {
      var _this = this;
      return u(o.children).each(function(x, i) {
    ...
    Dot.prototype.visitHash = function(o) {
      var _this = this;
      return u(o).each(function(value, key, index) {
        return _this.edge({
          key: value
        }, function() {
          return _this.visit({
    ...
    Dot.prototype.visitEdge = function(o, method) {
      var _this = this;
      return this.edge(method, function() {
    ...
    Dot.prototype.toDot = function() {
      var _this = this;
      return "digraph \"ARel\" {\nnode [width=0.375,height=0.25,shape=record];\n" + (u(this.nodes).map(function(node) {
        var label;
        label = "<f0>" + node.name;
